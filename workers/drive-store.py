...
(`N49E020.tif`, `ugkk-vysoke_tatry.tif`, `terrain-<kľúč>-<model>-z<zoom>.tar.zst`
...
drive = load("drive_serve", "drive-serve.py")     # Pool: Range, presmerovania
auth = load("drive_auth", "drive-auth.py")        # kto som, token, mazanie
folder = load("drive_folder", "drive-folder.py")  # výpis, priečinky, upload
