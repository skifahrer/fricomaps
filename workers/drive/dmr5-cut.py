#!/usr/bin/env python3
"""
„Dáta · DMR 5.0 z Drive": okno, bloky a výstupy – teda „ktorý kus a v akom tvare".
...
`Kontrola · workflowy a workery`). Rez je tam, kde sa mení otázka: tam „ako sa k tým dátam
