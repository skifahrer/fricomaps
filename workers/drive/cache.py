...
„Údržba · prihlásenie na Drive"). Čítanie readonly tokenu stačí, takže
build medzitým beží ďalej, len si nič neuloží.

NIČ SA NEMAŽE SAMO. GitHub si staré záznamy vyhadzoval sám, Drive nie – preto
je `--prune` a preto ho raz za týždeň spúšťa workflow „Údržba · upratať".
...
def creds_or_die(what):
    ...
    if creds is None:
        raise SystemExit(
            ...
            "vyrobí ich workflow „Údržba · prihlásenie na Drive“.")
    return creds
