 ...
 *
 * Použitie:
 *   node workers/build-sdf-sprite.mjs --in=_site/sprites/osm-liberty \
...
function packShelves(boxes, maxWidth) {
...
function main() {
  ...
  if (!inBase || !outBase) {
    console.error("Použitie: node workers/build-sdf-sprite.mjs --in=<base> --out=<base>");
    process.exit(2);
  }
